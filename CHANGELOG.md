...
- File nhà thầu đã đánh dấu: GIỮ NGUYÊN cấu trúc A / B (phần B "Phát sinh ngoài KLMT" đúng như nhà thầu tự khai). Hệ thống KHÔNG tự dời hạng mục từ phần A xuống B dựa vào kết quả ghép cặp PL01 nữa — vì ghép cặp có thể cho dương tính giả (mục KLMT hợp lệ nhưng không khớp PL01), làm dồn nhầm mục hợp lệ vào B. Thay vào đó, hạng mục không khớp PL01 được **tô màu + chú thích tại chỗ** (ngay trong phần A) để chuyên viên tự rà; mục B chỉ chứa đúng phát sinh nhà thầu đã khai. (Không còn sheet `— sắp xếp` / `— gốc`.)
- Bảng tổng hợp (nhiều nhà thầu) tổ chức theo cấu trúc **A/B** và CHUẨN HÓA thứ tự: hạng mục khớp được xếp lại theo **số thứ tự (STT) của bản chuẩn** kể cả khi nhà thầu chào lệch thứ tự (vật tư con vẫn bám dưới cha); hạng mục phát sinh dồn xuống cuối dưới tiêu đề mục **B — HẠNG MỤC PHÁT SINH NGOÀI KLMT**. Format giữ như file gốc (khối KLMT + block từng nhà thầu cạnh nhau) để so sánh nhiều nhà thầu.
